...
if ($Mode -eq 'After') {
    ...
    try {
        ...
        $requiredEntries = @(
            ...
            'tong/statmod/network/StatProgressNoticeMessage.class'
            'tong/statmod/command/StatsCommands.class'
            'tong/statmod/client/stats/StatsOverviewScreen.class'
            'tong/statmod/client/notice/ProgressNoticeOverlay.class'
