    ...
    static List<EntityType<?>> mobPool(FloorPalette t) {
        return switch(t) {
            case EARLY -> List.of(
                ...
                EntityType.STRAY, EntityType.SLIME, EntityType.ZOMBIE_VILLAGER
            );
            case MID -> List.of(
                ...
                EntityType.BLAZE, EntityType.STRAY, EntityType.SLIME
            );
            case LATE -> List.of(
                ...
                EntityType.BLAZE, EntityType.GUARDIAN, EntityType.MAGMA_CUBE
            );
            case ABYSS -> List.of(
